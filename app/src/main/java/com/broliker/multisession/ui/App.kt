                        ...
                        onDelete = {
                            ...
                            if (
                                ...
                                runCatching {
                                    ProfileStore
                                        .getInstance()
                                        .deleteProfile(session.profileName)
                                }
                            }
        ...
        text = {
            Column(
                ...
                if (groups.isNotEmpty()) {
                    Text(
                        "Existing groups: ${groups.joinToString(", ")}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            ...
            AndroidView(
                ...
                factory = { ctx ->
                    WebView(ctx).also { wv ->
                        ...
                        /*
                         * IMPORTANT:
                         * Bind the WebView to the selected profile FIRST.
                         * Do not touch settings, cookies, clients, or navigation
                         * before setProfile().
                         */
                        ...
                        /*
                         * Facebook/mobile sites are sensitive to stale or
                         * manually-forced desktop Chrome user agents.
                         *
                         * Keep the Android System WebView's current default
                         * user agent instead of forcing an old Chrome UA.
                         */
                        wv.settings.apply {
                            ...
                            /*
                             * Do NOT set a hard-coded userAgentString here.
                             * The system WebView default is intentionally used.
                             */
                        }

                        /*
                         * Use the CookieManager belonging to this profile.
                         * Falling back to the default CookieManager is only
                         * necessary on devices where MULTI_PROFILE is absent.
                         */
                        if (multiProfileSupported) {
                            runCatching {
                                ProfileStore
                        ...
                        wv.webViewClient = object : WebViewClient() {
                            ...
                            override fun onReceivedError(
                                ...
                                /*
                                 * Only show an error when the MAIN document
                                 * itself fails. Do not treat a failed image,
                                 * script, iframe, etc. as a full-page failure.
                                 */
                            ...
                            override fun onRenderProcessGone(
                                ...
                                errorMsg =
                                    if (detail.didCrash()) {
                                        "WebView renderer crashed. Please reload this session."
                                    } else {
                                        "WebView renderer was terminated. Please reload this session."
                                    }
                        ...
                        /*
                         * Only after profile + settings + cookie manager +
                         * clients are configured do we navigate.
                         */
                        wv.loadUrl(HOME_URL)
